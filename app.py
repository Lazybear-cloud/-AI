...
def analyze():
    try:
        ...
        **와 같은 볼드체 마크다운을 사용하지 말아주세요.
        ...
        대항력이 있는 선순위 임차인이 있지만 대항력 포기 확약서를 제출한 경우에는 '대항력 있는 선순위 임차인이 있으나, 대항력을 포기하여 인수하지 않음'이라고 해주세요.

        '명도 가능성'에는 임차인이 소유주이거나 배당을 받지 못하는 세입자인 경우에는 '이사비 협상 or 강제 집행'으로 해주고 배당을 받는 세입자인 경우 '명도 협상'으로 해주세요.
